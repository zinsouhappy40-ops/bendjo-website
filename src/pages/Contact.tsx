        ...
        <section className="overflow-hidden bg-cream bg-grain py-20 sm:py-28 lg:py-40" aria-labelledby="contact-title">
          <Container className="relative grid min-w-0 gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-end lg:gap-20">
            ...
            <div className="relative z-10 min-w-0">
              <p className="text-xs font-medium uppercase tracking-[0.2em] text-kraft">Contact</p>
              <h1 id="contact-title" className="mt-5 max-w-[10ch] font-display text-6xl leading-[0.92] text-leaf sm:text-7xl lg:text-[6.5rem]">Un mot, une idée, un moment.</h1>
            </div>
            <p className="max-w-md text-base leading-8 text-leaf/75 sm:text-lg">Une question sur les infusions, un besoin pour votre entreprise ou un événement à préparer ? Écrivez à BenDjo.</p>
          </Container>
        </section>
        ...
        <section className="bg-kraft/15 py-20 sm:py-28 lg:py-36" aria-labelledby="contact-form-title">
          <Container className="grid min-w-0 gap-12 lg:grid-cols-[1fr_0.75fr] lg:gap-24">
            <div className="min-w-0">
              <p className="text-xs font-medium uppercase tracking-[0.2em] text-kraft">Demande professionnelle</p>
              <h2 id="contact-form-title" className="mt-5 font-display text-5xl leading-[0.98] text-leaf sm:text-6xl">Présentez votre besoin.</h2>
              <p className="mt-5 max-w-xl leading-7 text-leaf/75">Renseignez les éléments dont vous disposez. Votre demande sera préparée dans WhatsApp avant que vous ne choisissiez de l’envoyer.</p>
            ...
            <div className="min-w-0 space-y-6 self-start">
              ...
              <aside className="relative overflow-hidden rounded-bendjo-lg bg-cream p-8 shadow-bendjo-soft sm:p-10" aria-labelledby="direct-contact-title">
                ...
                <h2 id="direct-contact-title" className="relative mt-8 font-display text-3xl text-leaf">Écrivez-nous directement.</h2>
                <p className="relative mt-4 leading-7 text-leaf/70">Vous pouvez aussi joindre BenDjo par email ou par téléphone.</p>
                <div className="relative mt-8 flex flex-col border-t border-leaf/15 pt-4 text-sm">
                  <a href="mailto:bendjobenin@gmail.com" className="inline-flex min-h-11 items-center rounded-bendjo-sm font-medium text-leaf hover:text-leaf/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf">bendjobenin@gmail.com</a>
                  <a href="tel:+2290153148013" className="inline-flex min-h-11 items-center rounded-bendjo-sm font-medium text-leaf hover:text-leaf/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-leaf">+229 01 53 14 80 13</a>
                </div>
              </aside>
            </div>
          </Container>
