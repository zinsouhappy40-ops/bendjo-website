        ...
        <section className="bg-kraft/15 py-8 sm:py-10 lg:py-12" aria-labelledby="contact-form-title">
          <Container className="grid min-w-0 gap-y-8 lg:gap-y-10">
            <div className="min-w-0 lg:max-w-2xl">
              <p className="type-label text-ink/75">Demande professionnelle</p>
              <h2 id="contact-form-title" className="type-section-title-lg mt-3 scroll-mt-24 text-ink">Présentez votre besoin.</h2>
              <p className="type-body mt-4 max-w-xl text-pretty text-ink/80">Renseignez les éléments dont vous disposez. Votre demande sera préparée dans WhatsApp avant que vous ne choisissiez de l’envoyer.</p>
            </div>
            ...
            <div className="min-w-0 max-w-4xl border-t border-leaf/30 pt-5 sm:pt-6">
              <aside aria-labelledby="direct-contact-title">
                <div className="flex items-start gap-3 sm:items-center sm:gap-4">
                  ...
                  <h2 id="direct-contact-title" className="type-section-title-compact text-ink">Écrivez-nous directement.</h2>
                </div>
