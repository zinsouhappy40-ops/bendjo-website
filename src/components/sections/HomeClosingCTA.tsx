    ...
    <section className="bg-kraft/20 pb-10 pt-14 sm:pb-12 sm:pt-16" aria-labelledby="home-closing-title">
      <Container className="lg:grid lg:grid-cols-[0.82fr_1.18fr] lg:items-end lg:gap-16">
        <div className="lg:pb-1">
          <p className="type-label text-ink/75">À vous de choisir la suite</p>
        ...
        <div className="mt-7 grid gap-6 border-t border-ink/20 pt-6 md:grid-cols-[1.1fr_0.9fr] md:gap-0 lg:mt-0 lg:grid-cols-2">
          <div>
