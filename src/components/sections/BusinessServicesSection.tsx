...
const contactLinkStyles = "type-action inline-flex min-h-12 w-full items-center justify-center rounded-bendjo-md bg-cream px-6 py-3 text-ink transition-colors hover:bg-cream/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cream focus-visible:ring-offset-2 focus-visible:ring-offset-ink sm:w-auto";
      ...
      <Container className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-24">
        <div>
          ...
          <div data-motion-group className="mt-10 border-t border-cream/25">
            ...
            <article data-motion-item className="grid gap-3 border-b border-cream/25 py-7 sm:grid-cols-[0.7fr_1fr] sm:gap-8">
              <h3 className="font-display text-2xl leading-tight text-cream">Service traiteur</h3>
