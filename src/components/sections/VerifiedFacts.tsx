...
function VerifiedFacts() {
  return (
    <section className="bg-cream py-8 sm:py-10 lg:py-12" aria-labelledby="verified-facts-title">
      <Container>
        <div className="border-b border-leaf/20 pb-3">
          <h2 id="verified-facts-title" className="type-section-title-compact text-leaf">Repères vérifiés</h2>
        </div>
        <ul data-motion-group className="mt-5 grid grid-cols-1 border-b border-leaf/15 sm:mt-6 sm:grid-cols-2">
