...
function Footer() {
  ...
  return (
    <footer className={isProductsPage ? "border-t border-leaf/25 bg-kraft text-leaf" : "bg-kraft text-leaf"}>
      ...
      >
        <div className="min-w-0">
          ...
          <p className="mt-2 max-w-xs text-sm leading-6 text-leaf">
        ...
        <nav aria-label="Navigation secondaire">
          <p className="text-sm font-medium">Navigation</p>
            <div className={isAboutPage || isProductsPage ? "mt-2 flex flex-col items-start gap-1.5 text-sm text-leaf" : "mt-2 flex flex-col items-start gap-2 text-sm text-leaf"}>
        ...
        <div className="min-w-0">
          <p className="text-sm font-medium">Ancrage</p>
           <p className="mt-2 flex items-center gap-2 text-sm leading-6 text-leaf"><MapPin size={17} weight="regular" aria-hidden="true" />Cotonou, Bénin</p>
          <div className={isAboutPage || isProductsPage ? "mt-2.5 flex flex-wrap gap-x-4 gap-y-1.5 text-sm text-leaf" : "mt-3 flex flex-wrap gap-x-4 gap-y-2 text-sm text-leaf"}>
      ...
      <p className={isAboutPage || isProductsPage
        ? "border-t border-leaf/35 px-5 py-3.5 text-center text-xs text-leaf sm:px-6 lg:px-8"
         : "border-t border-leaf/25 px-5 py-3.5 text-center text-xs text-leaf sm:px-6 lg:px-8"}
      >
